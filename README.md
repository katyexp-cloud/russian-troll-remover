...
-x-x-x-x-x-x-x-x-x-x-x- Cancelled, because most social platforms don't let you delete massive amount of comments regularly. Yes - by deleting bot comments by bot, you can get flagged for bot activity -x-x-x-x-x-x-x-x-x-x-x-
